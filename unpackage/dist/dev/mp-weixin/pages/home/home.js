...
var _home = _interopRequireDefault(__webpack_require__(/*! ./pages/home/home.vue */ 156));
// @ts-ignore
...
/* harmony import */ var _home_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./home.vue?vue&type=style&index=0&lang=scss& */ 163);
...
try {
  components = {
    ...
    uniGroup: function () {
      return __webpack_require__.e(/*! import() | uni_modules/uni-group/components/uni-group/uni-group */ "uni_modules/uni-group/components/uni-group/uni-group").then(__webpack_require__.bind(null, /*! @/uni_modules/uni-group/components/uni-group/uni-group.vue */ 433))
    },
    qiunDataCharts: function () {
      return Promise.all(/*! import() | uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts")]).then(__webpack_require__.bind(null, /*! @/uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts.vue */ 440))
    },
  }
} catch (e) {
  if (
...
var _default = {
  data: function data() {
    return {
      ...
      //选择的分店
      xzindex: '3',
      tablecolor: ["#1890FF", "#FAC858", "#EE6666", "#73C0DE", "#3CA272", "#FC8452", "#9A60B4", "#ea7ccc", "#1890FF", "#FAC858"],
      three: '',
      //近三天
      one: '',
      //近一天
  ...
  methods: {
    ...
    manage: function manage(e) {
      ...
      var table = [];
      for (var _i = 0, _Object$entries = Object.entries(table0); _i < _Object$entries.length; _i++) {
      ...
      //剔除会员和促销
      var newdata = [];
      var _iterator = _createForOfIteratorHelper(this.ybpdata.Table[0]),
        _step;
      try {
    ...
    //可视化面板
    // 部门经营分析
    getServerDataA: function getServerDataA() {
      var _this4 = this;
      //模拟从服务器获取数据时的延时
      setTimeout(function () {
    ...
    //销售占比饼状图
    getServerDataB: function getServerDataB() {
      var _this5 = this;
      //模拟从服务器获取数据时的延时
      setTimeout(function () {
        //模拟服务器返回数据，如果数据格式和标准格式不同，需自行按下面的格式拼接
    ...
    //销售占比分析
    getServerDataC: function getServerDataC() {
      var _this6 = this;
      //模拟从服务器获取数据时的延时
      setTimeout(function () {
        //模拟服务器返回数据，如果数据格式和标准格式不同，需自行按下面的格式拼接
    ...
    //会员分析
    getServerDataE: function getServerDataE() {
      var _this7 = this;
      //模拟从服务器获取数据时的延时
      setTimeout(function () {
        var data = [];
        ...
        var title = [];
        for (var _i2 = 0, _Object$entries2 = Object.entries(test); _i2 < _Object$entries2.length; _i2++) {
        ...
        var table1 = [];
        for (var _i3 = 0, _Object$entries3 = Object.entries(_this7.ybpdata.Table3[1]); _i3 < _Object$entries3.length; _i3++) {
        ...
        var table2 = [];
        for (var _i4 = 0, _Object$entries4 = Object.entries(_this7.ybpdata.Table3[2]); _i4 < _Object$entries4.length; _i4++) {
    ...
    //分店销售分析
    getServerDataF: function getServerDataF() {
      var _this8 = this;
      //模拟从服务器获取数据时的延时
      setTimeout(function () {
        //模拟服务器返回数据，如果数据格式和标准格式不同，需自行按下面的格式拼接
    ...
    //时段分析
    getServerDataG: function getServerDataG() {
      var _this9 = this;
      //模拟从服务器获取数据时的延时
      setTimeout(function () {
        //模拟服务器返回数据，如果数据格式和标准格式不同，需自行按下面的格式拼接
    ...
    //15天数据
    getServerDataD: function getServerDataD() {
      var _this10 = this;
      //模拟从服务器获取数据时的延时
      setTimeout(function () {
        //模拟服务器返回数据，如果数据格式和标准格式不同，需自行按下面的格式拼接
    ...
    getdata2: function getdata2(item, index) {
      var _this11 = this;
      this.xzindex = index;
      var getpcadmindaysaledata = {
        access_token: uni.getStorageSync('access_token'),
